...
export const LUA_API_REFERENCE: LuaApiEntry[] = [
  ...
  { group: "camera", kind: "function", name: "vweb.camera.setSubject", signature: "(player)", summary: "Follows a local or remote player by id, name, or me/local.", snippet: "vweb.camera.setSubject(\"monsterenergy\")" },
  { group: "camera", kind: "function", name: "vweb.camera.setTarget", signature: "(player)", summary: "Alias for setSubject.", snippet: "vweb.camera.setTarget(\"18154\")" },
  { group: "camera", kind: "function", name: "vweb.camera.clearSubject", signature: "()", summary: "Returns the camera to the local player.", snippet: "vweb.camera.clearSubject()" },
  { group: "camera", kind: "function", name: "vweb.camera.getSubject", signature: "()", summary: "Returns the current script camera subject.", snippet: "local subject = vweb.camera.getSubject()" },
